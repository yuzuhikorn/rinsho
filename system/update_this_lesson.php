<?php
	if ($_POST) {
		...
		connect_to_mysql("update lesson set 研修名='".$lesson_name."',開始日時='".$start."',終了日時='".$finish."',講師='".$teacher."',講師所属='".$laboratory."',会場='".$place."',料金='".$fee."' where 研修ID='".$lesson_id."'");
		print "update lesson set 研修名='".$lesson_name."',開始日時='".$start."',終了日時='".$finish."',講師='".$teacher."',講師所属='".$laboratory."',会場='".$place."',料金='".$fee."' where 研修ID='".$lesson_id."'";
			if(!$res){
