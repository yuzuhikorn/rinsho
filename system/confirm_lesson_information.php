...
<?php
	if ($_POST) {
		...
		print "<tr><td bgcolor='lightpink' width='200'>start</td><td width='500'>".$start_month."-".$start_day." ".$start_hour.":".$start_minute."</td></tr>";
		print "<tr><td bgcolor='lightpink' width='200'>finish</td><td width='500'>".$finish_month."-".$finish_day." ".$finish_hour.":".$finish_minute."</td></tr>";
